...
byte ip[] = {
  192, 168, 0, 10}; // the IP adress of your device, that should be in same universe of the network you are using
...
const int number_of_channels = 504; //up to 512 channels; using 192 right now = 8 strips * 8 rgb LEDs per strip * 3 colors
